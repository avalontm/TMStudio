...
namespace TMStudio.Controls
{
    public class ProgressRing : TemplatedControl
    {
        ...
        public static readonly StyledProperty<bool> IsActiveProperty =
            AvaloniaProperty.Register<ProgressRing, bool>(nameof(IsActive), defaultValue: true, false, defaultBindingMode: Avalonia.Data.BindingMode.OneWay, coerce: OnIsActiveChanged);
